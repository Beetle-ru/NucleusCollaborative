...
namespace Converter
{
    //  Счетчик подтверждения задания весы 3
    ...
    public class cntWeigher3JobReadyEvent : ConverterBaseEvent
    {
        [DataMember]
        [DBPoint(IsStored = true)]
        [PLCPoint(IsWritable = true, Location = "DB1,INT478")]
        public int Counter { set; get; }               // Счетчик                                        # SP_CX_CNT_TASK_ACKNOW3

        private static int m_counter = 1;

        public cntWeigher3JobReadyEvent()
        {
