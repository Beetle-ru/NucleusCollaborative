...
namespace Converter
{
    // Симулятор суммарного О2 для весов W6					
    ...
    public class comOxigenW6SimilatorEvent : ConverterBaseEvent
    {
        [DataMember]
        [DBPoint(IsStored = true)]
        [PLCPoint(Location = "DB1,INT504", IsWritable = true)]
        public int VirtualOxygen { set; get; }                                            // # SP_CX_O2_SIMUW6
