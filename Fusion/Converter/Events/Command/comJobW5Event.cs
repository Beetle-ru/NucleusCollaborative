...
namespace Converter
{
    ...
    public class comJobW5Event : ConverterBaseEvent
    {
        [DataMember]
        [DBPoint(IsStored = true)]
        [PLCPoint(IsWritable = true, Location = "DB1,REAL40")]
        public double RB8Weight { set; get; }                        // Заданный вес бункер 8      # SP_CX_ADDMAINP1WGT4
        ...
        public int RB8Oxygen { set; get; }                             // O2 расход бункер 8      # SP_CX_ADDSTEPP1MAT4

        public comJobW5Event()
        {
            RB8Weight = -1;
            RB8Oxygen = -1;
        }
