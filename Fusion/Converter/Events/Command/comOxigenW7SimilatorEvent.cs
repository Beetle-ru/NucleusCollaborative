...
namespace Converter
{
    // Симулятор суммарного О2 для весов W7					
    ...
    public class comOxigenW7SimilatorEvent : ConverterBaseEvent
    {
        [DataMember]
        [DBPoint(IsStored = true)]
        [PLCPoint(Location = "DB1,INT508", IsWritable = true)]
        public int VirtualOxygen { set; get; }                                            // # SP_CX_O2_SIMUW7
