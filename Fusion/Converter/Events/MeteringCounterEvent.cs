...
namespace Converter
{
    ...
    // Счетчик замеров зондом, происходит в момент поднятия зонда	
    [Serializable]
    [DataContract]
    ...
    public class MeteringCounterEvent : ConverterBaseEvent
    {
        [DataMember]
        [DBPoint(IsStored = true)]
        [PLCPoint(Location = "DB2,INT10")]
        public int Cnt { set; get; }               // Счетчик замеров
    }
}
