...
namespace Converter
{
    // Симулятор суммарного О2 для весов W4					
    ...
    public class comOxigenW4SimilatorEvent : ConverterBaseEvent
    {
        [DataMember]
        [DBPoint(IsStored = true)]
        [PLCPoint(Location = "DB1,INT496", IsWritable = true)]
        public int VirtualOxygen { set; get; }                                            // # SP_CX_O2_SIMUW4
