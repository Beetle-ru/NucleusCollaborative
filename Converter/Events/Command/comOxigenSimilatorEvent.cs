...
namespace Converter
{
    ...
    public class comOxigenSimilatorEvent : ConverterBaseEvent
    {
        [DataMember]
        [DBPoint(IsStored = true)]
        [PLCPoint(Location = "DB1,INT488", IsWritable = true)]
        public int VirtualOxygen { set; get; }                                            // # SP_CX_O2_SIMU
