...
namespace Converter
{
    //  Счетчик подтверждения задания весы 6
    ...
    public class cntWeigher6JobReadyEvent : ConverterBaseEvent
    {
        [DataMember]
        [DBPoint(IsStored = true)]
        [PLCPoint(IsWritable = true, Location = "DB1,INT484")]
        public int Counter { set; get; }               // Счетчик                                        # SP_CX_CNT_TASK_ACKNOW6

        private static int m_counter = 1;

        public cntWeigher6JobReadyEvent()
        {
