...
namespace Converter
{
    // Симулятор суммарного О2 для весов W3					
    ...
    public class comOxigenW3SimilatorEvent : ConverterBaseEvent
    {
        [DataMember]
        [DBPoint(IsStored = true)]
        [PLCPoint(Location = "DB1,INT492", IsWritable = true)]
        public int VirtualOxygen { set; get; }                                            // # SP_CX_O2_SIMUW3
