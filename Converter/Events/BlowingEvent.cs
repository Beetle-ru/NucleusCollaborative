...
namespace Converter
{
    ...
    public class BlowingEvent : ConverterBaseEvent
    {
        [DataMember]
        ...
        [DataMember]
        [DBPoint(IsStored = true)]
        [PLCPoint(Location = "DB2,W20")]
        public int BlowingFlag { set; get; }              // главная продувка нач/кон 1=старт продувки, 0=конец продувки  # ACT_CX_BLOWING
    }
}
